    ...
    remoteMedia.forEach((remoteItem) => {
      ...
      if (localItem) {
        ...
        const mergedItem = {
          ...
          // Prefer the local poster_url (served by our own API) over the remote
          // Jellyfin URL, which may be slow or require auth when the server is
          // temporarily unreachable.
          poster_url: localItem.poster_url || remoteItem.poster_url,
