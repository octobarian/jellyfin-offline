...
class MediaManager:
    ...
    def play_local_media(self, media_id: str, fullscreen: bool = False) -> bool:
        ...
        return self.vlc_controller.play_local_file(media_item.local_path, fullscreen, title=media_item.title)
    ...
    def stream_media(self, media_id: str, fullscreen: bool = False) -> bool:
        ...
        return self.vlc_controller.play_stream(stream_url, fullscreen, title=media_item.title)
    ...
    def _handle_download_completion(self, completed_task: DownloadTask) -> None:
        ...
        try:
            ...
            # Download poster BEFORE scanning so _find_local_poster() finds it
            # when the scan builds the DB entry - otherwise there's a race where
            # the frontend refreshes before the poster download finishes.
    ...
    def _merge_media_items(self, local_item: MediaItem, remote_item: MediaItem) -> MediaItem:
        ...
        return MediaItem(
            ...
            file_size=remote_item.file_size or local_item.file_size,
